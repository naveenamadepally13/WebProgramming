...
var app = express();
var url='mongodb+srv://naveena:naveena@cluster0-6rknx.mongodb.net/libraryManagement';
//Add your cluster URL till /test...here libraryManagement is my db name and books is my table name
...
app.post('/create', function (req, res) {
    MongoClient.connect(url, function(err, db) {
        var dbase = db.db('libraryManagement');
        if(err)
        {
